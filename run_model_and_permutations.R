...
# to preserve subject-level variance in the permutations, records are swapped between subjects with same number of records 
# to avoid that records cannot be swapped as there are only few subjects with that number of records, max_records sets the maximum number of records per subject
max_records   = 3 
...
data           = prep_permute_response_stratify(data,max_records)
